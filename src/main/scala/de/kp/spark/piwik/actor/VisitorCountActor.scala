...
object VisitorCountActor {

  sealed trait VisitorCountMessage
  case class Unregister(ws:WebSocket) extends VisitorCountMessage

}

class VisitorCountActor extends Actor with ActorLogging {

  import VisitorCountActor._
